...
% Os dados utilizados para o desenvolvimento dos modelos preditivos consistem de 1267 amostras de diversos compostos químicos, tendo como saída a solubilidade do composto. Enquanto os preditores são divididos em três grupos, o primeiro com 208 preditores binários referentes a presença de uma determinada subestrutura química específica, o segundo com 16 preditores com a contagem de ligações químicas e determinados tipos de átomos, e o terceiro com quatro preditores contínuos com características dos compostos, como por exemplo a massa molecular.
