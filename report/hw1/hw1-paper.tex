...
\begin{enumerate}
     \item \textbf{\textit{id}} (primary key): identification of each patient, final target.
     \item \textbf{\textit{diagnosis}} (M/B): sample class, it can be either \textbf{M} for Malignant, or \textbf{B} for Benign.
     ...
     \item \textbf{\textit{perimeter se}}: error perimeter.
